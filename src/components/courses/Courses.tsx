    ...
    <div className="courses-wrapper">
      <div className="course-content">
        ...
        <p className="text-secondary">
          ...
          development strategies, requirements analysis, design tools, and
          testing methodologies will be covered. These concepts will be explored
          in theory as well as in practice; students will gain experience in
          conceiving, specifying, designing, developing and implementing a
        ...
        <p className="text-secondary">
          ...
          stored, accessed, and ultimately analyzed. Cloud concepts,
          capabilities, and computing models will be explored and will include
          hands-on experiences with tools for working with large-scale
          distributed file systems (e.g., Hadoop). Students will also develop
          skills working with relational databases (e.g., SQL) and unstructured
        ...
        <p className="text-secondary">
          ...
          algorithms for classification, estimation, and clustering. Specific
          topics will vary but may include artificial neural networks, decision
          trees, instance-based learning, Bayesian learning, support vector
          machines, hidden Markov models, text categorization, and k-means
        ...
        <p className="text-secondary">
          ...
          operating systems. Problems of resource allocation, concurrency, file
        ...
        <p className="text-secondary">
          ...
          intelligence. Topics include knowledge representation, predicate
          calculus, basic data structures, and problem solving strategies. A
          symbol manipulation language is used. Computer science aspects of
          artificial intelligence are emphasized. Applications from areas such
        ...
        <p className="text-secondary">
          ...
          efficiency of algorithms. Implementation and analysis of advanced
          algorithms and data structures such as AVL trees, B-trees,
        ...
        <p className="text-secondary">
          ...
          perspectives of design and implementation. Syntactic and semantic
          features are examined in a variety of languages. Run-time structures
          for handling both data and control structures are introduced. The
        ...
        <p className="text-secondary">
          ...
          from advances in computer technology, and the responsibility that
          computer professionals and users have with regards to computer use.
          The course will serve to increase understanding of issues related to
          ethics, professional conduct and social responsibility as they arise
          in the field of computer science. Students will be exposed to the
          ...
          within the discipline. Additionally, the course serves to develop 1)
        ...
        <p className="text-secondary">
          ...
          course is to understand data abstraction in computer science and to
          learn how to implement user-defined data types in an object-oriented
        ...
        <p className="text-secondary">
          ...
          emphasizing problem solving using a high-level programming language.
          Algorithms, basic data representation, language control structures,
        ...
        <h5 className="text-secondary">
          ...
          <a href="https://www.drake.edu/cs/courses/">Link</a>
        </h5>
        <br />
      </div>
    </div>
